...
{
    public partial class newsajax_gz : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(Request["page"]))
            {
                ...
                string sqlstr = "select top " + Pagesize + " * from Sys_News where iID not in (select top " + PageCount + " iID from Sys_News where (iTypeID=12 or iTypeID=13 or iTypeID=14 or iTypeID=15 or iTypeID=16 or iTypeID=27) and bIsAudit = 1 order by iID desc) and (iTypeID=12 or iTypeID=13 or iTypeID=14 or iTypeID=15 or iTypeID=16 or iTypeID=27) and bIsAudit = 1 order by iID desc";
