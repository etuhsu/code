<%@ WebHandler Language="C#" Class="QueryServerList" %>
using System;
using System.Web;
...
public class QueryServerList : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        context.Response.Write(bll.GetServerList(limit, pageno, strWhere.ToString()));
    }
