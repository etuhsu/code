<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CxxxNews.aspx.cs" Inherits="XxWapSystem.news.CxxxNews" %>
...
<h1>楼盘促销</h1>
    ...
    <div class="ntab_title">
        <ul>
            ...
            <li class="selected"><a href="CxxxNews.aspx">楼盘促销</a></li>
    ...
    <script type="text/javascript">
        var page = 2;
        var url = "newsajax.aspx?channel=<%=colid %>";
