...
namespace XxWapSystem.DAL
{
    ...
    public partial class D_ES_Buy
    {
        ...
        public bool Exists(int ID)
        {
            ...
            int result = DBHelper.RunProcedure("Al_ES_Buy_Exists", parameters, out rowsAffected);
            if (result == 1)
            {
                return true;
            }
        ...
        ///  增加一条数据
        /// </summary>
        public int Add(XxWapSystem.Model.Al_ES_Buy model, int AddNum, string uType, ref int NID, ref string ReMessage)
        {
            int rowsAffected;
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4),
					...
					new SqlParameter("@BuildType", SqlDbType.Int,4),
					...
					new SqlParameter("@BMessage", SqlDbType.NVarChar,200),
            ...
            parameters[7].Value = model.Construction;
            parameters[8].Value = model.BuildType;
            parameters[9].Value = model.direction;
            parameters[10].Value = model.Price;
            parameters[11].Value = model.HouseMess;
            parameters[12].Value = model.Linker;
            parameters[13].Value = model.Phone;
            parameters[14].Value = model.AddTime;
            parameters[15].Value = model.UpdateUID;
            parameters[16].Value = model.UpdateTime;
            parameters[17].Value = model.UID;
            parameters[18].Value = model.Click;
            parameters[19].Value = model.IsMiddle;
            parameters[20].Value = model.MiddleID;
            parameters[21].Value = model.CompareID;
            parameters[22].Value = model.DelUID;
            parameters[23].Value = model.DelTime;
            parameters[24].Value = model.IsDel;
            parameters[25].Value = model.IsHot;
            parameters[26].Value = model.IsTop;
            parameters[27].Value = model.EndTime;

            parameters[28].Value = AddNum;
            parameters[29].Value = "求购";
            parameters[30].Value = uType;
            parameters[31].Direction = ParameterDirection.Output;
            parameters[32].Direction = ParameterDirection.Output;
            parameters[33].Value = model.IsOk;
            parameters[34].Value = model.HomeType1;
            parameters[35].Value = model.HomeType2;

            DBHelper.RunProcedure("Al_ES_Buy_Update", parameters, out rowsAffected);


            NID = Convert.ToInt32(parameters[31].Value);
            ReMessage = parameters[32].Value.ToString();
        ...
        /// 得到一个对象实体
        /// </summary>
        public XxWapSystem.Model.Al_ES_Buy GetModel(int ID)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@tablename", SqlDbType.NVarChar,50),
					new SqlParameter("@ID", SqlDbType.Int,4),
            ...
            parameters[0].Value = "V_Al_ES_Buy";
            parameters[1].Value = ID;
            parameters[2].Value = "";

            XxWapSystem.Model.Al_ES_Buy model = new XxWapSystem.Model.Al_ES_Buy();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    model.BuildType = int.Parse(ds.Tables[0].Rows[0]["BuildType"].ToString());
                }
                if (ds.Tables[0].Rows[0]["BuildTypeName"] != null && ds.Tables[0].Rows[0]["BuildTypeName"].ToString() != "")
                {
                    model.BuildTypeName = ds.Tables[0].Rows[0]["BuildTypeName"].ToString();
                }
                ...
                if (ds.Tables[0].Rows[0]["DelTime"] != null && ds.Tables[0].Rows[0]["DelTime"].ToString() != "")
                {
                    model.DelTime = DateTime.Parse(ds.Tables[0].Rows[0]["DelTime"].ToString());
                }
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM V_Al_ES_Buy ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from V_Al_ES_Buy T ");
        ...
        {
            PagerInfo PI = new PagerInfo("V_Al_ES_Buy", strGetFields, orderby, PageSize, PageIndex, bDesc, strFliter);
            PI.DoPager();
            return PI;
        }
