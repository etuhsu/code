<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XydaShowRy.aspx.cs" Inherits="XxWapSystem.zx_xyda.XydaShowRy" %>
...
<H1>岳阳市装饰装修企业基本情况 </H1>
    ...
    <div class="ntab_title">
        <ul>
            ...
            <li class="selected"><a href="XydaShowRy.aspx?id=<%=Request["id"]%>">从业人员</a></li>
                ...
                <table cellspacing="0" cellpadding="4" align="center" width="100%" border="1">
                    <tr>
                        <td height="29" background="images/bg2.gif" align="left">
                            <span class="STYLE50">企 业 持 证 上 岗 人 员 名 单</span>
                        </td>
                    </tr>
