...
{
    /// <summary>
    /// 业务逻辑类Al_BuildingImageType 的摘要说明。
    /// </summary>
    public class Al_BuildingImageType
    {
        private static readonly XxWapSystem.DAL.Al_BuildingImageType dal = new XxWapSystem.DAL.Al_BuildingImageType();
