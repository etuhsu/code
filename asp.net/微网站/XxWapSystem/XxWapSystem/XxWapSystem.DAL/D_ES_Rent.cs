...
namespace XxWapSystem.DAL
{
    ...
    /// 数据访问类:Al_ES_Rent
    /// </summary>
    public partial class D_ES_Rent
    {
        public D_ES_Rent()
        { }
        #region  Method
        ...
        public bool Exists(int ID)
        {
            ...
            int result = DBHelper.RunProcedure("Al_ES_Rent_Exists", parameters, out rowsAffected);
            if (result == 1)
            {
                return true;
            }
        ...
        ///  增加一条数据
        /// </summary>
        public int Add(XxWapSystem.Model.Al_ES_Rent model, int AddNum, string uType, ref int NID, ref string ReMessage)
        {
            int rowsAffected;
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4),
					...
					new SqlParameter("@cupboardSquare", SqlDbType.Float,8),
					...
					new SqlParameter("@RMessage", SqlDbType.NVarChar,200),
            ...
            parameters[12].Value = model.darage;
            parameters[13].Value = model.cupboard;
            parameters[14].Value = model.cupboardSquare;
            parameters[15].Value = model.elevator;
            parameters[16].Value = model.FloorNum;
            parameters[17].Value = model.MaxFloor;
            parameters[18].Value = model.HouseAge;
            parameters[19].Value = model.Price;
            parameters[20].Value = model.Other;
            parameters[21].Value = model.Phone;
            parameters[22].Value = model.Linker;
            parameters[23].Value = model.Email;
            parameters[24].Value = model.HouseMess;
            parameters[25].Value = model.AddTime;
            parameters[26].Value = model.UpdateUID;
            parameters[27].Value = model.UpdateTime;
            parameters[28].Value = model.Bus;
            parameters[29].Value = model.IsMiddle;
            parameters[30].Value = model.UID;
            parameters[31].Value = model.Click;
            parameters[32].Value = model.MiddleID;
            parameters[33].Value = model.CompareID;
            parameters[34].Value = model.DelUID;
            parameters[35].Value = model.IsDel;
            parameters[36].Value = model.IsHot;
            parameters[37].Value = model.IsTop;
            parameters[38].Value = model.EndTime;

            parameters[39].Value = model.Pic1;
            parameters[40].Value = model.Pic2;
            parameters[41].Value = model.Pic3;


            parameters[42].Value = AddNum;
            parameters[43].Value = "出租";
            parameters[44].Value = uType;
            parameters[45].Direction = ParameterDirection.Output;
            parameters[46].Direction = ParameterDirection.Output;
            parameters[47].Value = model.IsOk;
            parameters[48].Value = model.HomeType1;
            parameters[49].Value = model.HomeType2;

            DBHelper.RunProcedure("Al_ES_Rent_Update", parameters, out rowsAffected);

            NID = Convert.ToInt32(parameters[45].Value);
            ReMessage = parameters[46].Value.ToString();
        ...
        /// 得到一个对象实体
        /// </summary>
        public XxWapSystem.Model.Al_ES_Rent GetModel(int ID)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@tablename", SqlDbType.NVarChar,50),
					new SqlParameter("@ID", SqlDbType.Int,4),
            ...
            parameters[0].Value = "V_Al_ES_Rent";
            parameters[1].Value = ID;
            parameters[2].Value = "";

            XxWapSystem.Model.Al_ES_Rent model = new XxWapSystem.Model.Al_ES_Rent();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM V_Al_ES_Rent ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from V_Al_ES_Rent T ");
        ...
        {
            PagerInfo PI = new PagerInfo("V_Al_ES_Rent", strGetFields, orderby, PageSize, PageIndex, bDesc, strFliter);
            PI.DoPager();
            return PI;
        }
