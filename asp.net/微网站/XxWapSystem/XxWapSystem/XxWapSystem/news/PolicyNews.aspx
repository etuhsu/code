<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PolicyNews.aspx.cs" Inherits="XxWapSystem.news.PolicyNews" %>
...
<h1>政策新闻</h1>
    ...
    <div class="ntab_title">
        <ul>
            ...
            <li class="selected"><a href="PolicyNews.aspx">政策新闻</a></li>
        ...
        <div class="nplist">
            <ul>
                <asp:Repeater ID="rptlist" runat="server">
                    <ItemTemplate>
                        <li onclick="gourl('PolicyNewShow.aspx?id=<%#Eval("Id").ToString()%>')">
                            <div class="p-img">
                                <a target="_self" href="PolicyNewShow.aspx?id=<%#Eval("Id").ToString()%>">
                                    <img width="50" height="50" alt="<%#Eval("Title").ToString()%>" src="<%# IsImg(Eval("TitleImgPath").ToString())%>" />
                                </a>
                            </div>
                            <div class="p-txt">
                                <div class="p-title">
                                    <a target="_self" href="PolicyNewShow.aspx?id=<%#Eval("Id").ToString()%>"><%#Eval("Title").ToString()%> </a>
                                </div>
                                <div class="p-summary">
                                    <%# IsShort(Eval("ShortContent").ToString(), Eval("Content").ToString())%>
                                </div>
                            </div>
                        </li>
                    </ItemTemplate>
    ...
    <script type="text/javascript">
        var page = 2;
        var url = "newsajax_zcxw.aspx?channel=<%=colid %>";
