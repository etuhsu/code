...
namespace XxWapSystem.DAL
{
    ...
    public partial class Al_Area
    {
        ...
        public bool Exists(int iID)
        {
            ...
            int result = DBHelper.RunProcedure("FC_UP_Al_Area_Exists", parameters, out rowsAffected);
            if (result == 1)
            {
                return true;
            }
        ...
        ///  增加一条数据
        /// </summary>
        public funRtn Add(XxWapSystem.Model.Al_Area model)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@iID", SqlDbType.Int,4),
					new SqlParameter("@cAreaName", SqlDbType.NVarChar,50),
            ...
            parameters[1].Value = model.cAreaName;
            parameters[2].Value = model.dAddTime;
            parameters[3].Value = model.iSort;
            parameters[4].Direction = ParameterDirection.Output;
            parameters[5].Direction = ParameterDirection.Output;
            DBHelper.RunProcedure("FC_UP_Al_Area_ADD", parameters);
        ...
        ///  更新一条数据
        /// </summary>
        public funRtn Update(XxWapSystem.Model.Al_Area model)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@iID", SqlDbType.Int,4),
					new SqlParameter("@cAreaName", SqlDbType.NVarChar,50),
            ...
            parameters[4].Direction = ParameterDirection.Output;
            parameters[5].Direction = ParameterDirection.Output;
            DBHelper.RunProcedure("FC_UP_Al_Area_Edit", parameters);
        ...
        public funRtn Delete(int iID)
        {
            ...
            DBHelper.RunProcedure("FC_UP_Al_Area_Delete", parameters);
        ...
        /// 得到一个对象实体
        /// </summary>
        public XxWapSystem.Model.Al_Area GetModel(int iID)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@iID", SqlDbType.Int,4)};
            parameters[0].Value = iID;

            XxWapSystem.Model.Al_Area model = new XxWapSystem.Model.Al_Area();
            DataSet ds = DBHelper.RunProcedure("FC_UP_Al_Area_GetModel", parameters, "ds");
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                model.cAreaName = ds.Tables[0].Rows[0]["cAreaName"].ToString();
        ...
        {
            PagerInfo PI = new PagerInfo("Al_Area", strGetFields, "iID", PageSize, PageIndex, bDesc, strFliter);
            PI.DoPager();
            return PI;
        }
        #endregion  Method
