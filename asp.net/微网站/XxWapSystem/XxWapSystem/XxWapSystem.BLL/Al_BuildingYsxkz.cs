...
{
    /// <summary>
    /// 业务逻辑类Al_BuildingYsxkz 的摘要说明。
    /// </summary>
    public class Al_BuildingYsxkz
    {
        private static readonly XxWapSystem.DAL.Al_BuildingYsxkz dal = new XxWapSystem.DAL.Al_BuildingYsxkz();
