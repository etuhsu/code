<%@ WebHandler Language="C#" Class="ModifySrList" %>
...
using System.Text;
public class ModifySrList : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        model.SR_ID = Convert.ToInt32(context.Request["SR_ID"].ToString());
        ...
        model.SR_UPDATEUID = userStr;

        Res.BLL.SrBLL bll = new SrBLL();
        if (bll.UpdateSRList(model) > 0)
        {
