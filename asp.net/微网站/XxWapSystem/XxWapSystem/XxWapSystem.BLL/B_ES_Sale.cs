...
{
    /// <summary>
    /// 二手房出售业务逻辑类Al_ES_Sale
    /// </summary>
    public class B_ES_Sale
    {
        private static readonly XxWapSystem.DAL.D_ES_Sale dal = new XxWapSystem.DAL.D_ES_Sale();
        public B_ES_Sale() { }
        ...
        /// 增加一条二手房出售数据
        /// </summary>
        public int Add(XxWapSystem.Model.Al_ES_Sale model,string uType,ref int NID,ref string ReMessage)
        {
        ...
        /// 得到一个二手房出售实体
        /// </summary>
        public XxWapSystem.Model.Al_ES_Sale GetModel(int iID)
        {
