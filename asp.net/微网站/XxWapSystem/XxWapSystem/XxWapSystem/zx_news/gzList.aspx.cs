...
namespace XxWapSystem.zx_news
{
    public partial class gzList : System.Web.UI.Page
    {
        ...
        {
            string sqlstr = "select top 10 * from Sys_News where (iTypeID=12 or iTypeID=13 or iTypeID=14 or iTypeID=15 or iTypeID=16 or iTypeID=27) and bIsAudit = 1 order by iID desc";
