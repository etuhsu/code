<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XydaShowLh.aspx.cs" Inherits="XxWapSystem.zx_xyda.XydaShowLh" %>
...
<H1>岳阳市装饰装修企业基本情况 </H1>
    ...
    <div class="ntab_title">
        <ul>
            ...
            <li class="selected"><a href="XydaShowLh.aspx?id=<%=Request["id"]%>">良好信息</a></li>
                ...
                <table cellspacing="0" bordercolordark="#ffffff" cellpadding="4" align="center" bordercolorlight="#333333"
                    ...
                    <tr>
                        <td height="29" background="images/bg2.gif" align="left">
                            <span class="STYLE50">企业良好信用记录</span>
                        </td>
                    </tr>
