<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="znlist.aspx.cs" Inherits="XxWapSystem.news.znlist" %>
...
<h1>装修资讯-办事指南</h1>
    ...
    <div class="ntab_title">
        <ul>
            ...
            <li class="selected"><a href="znList.aspx">办事指南</a></li>
        </ul>
    </div>
    <div class="clear">
    </div>
