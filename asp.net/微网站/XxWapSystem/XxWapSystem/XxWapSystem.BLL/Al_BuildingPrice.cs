...
{
    /// <summary>
    /// 业务逻辑类Al_BuildingPrice 的摘要说明。
    /// </summary>
    public class Al_BuildingPrice
    {
        private static readonly XxWapSystem.DAL.Al_BuildingPrice dal = new XxWapSystem.DAL.Al_BuildingPrice();
