<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gzList.aspx.cs" Inherits="XxWapSystem.zx_news.gzList" %>
...
<h1>装修资讯-行业规章</h1>
    ...
    <div class="ntab_title">
        <ul>
            <li><a href="NewsList.aspx">行业动态</a></li>
            <li><a href="jjList.aspx">行业简介</a></li>
            <li class="selected"><a href="gzList.aspx">行业规章</a></li>
