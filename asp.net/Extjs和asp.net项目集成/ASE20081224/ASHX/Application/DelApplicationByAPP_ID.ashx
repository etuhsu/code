<%@ WebHandler Language="C#" Class="DelApplicationByAPP_ID" %>
...
public class DelApplicationByAPP_ID : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context)
    {
        ...
        int result = bll.DelApplicationByAPP_ID(IDArray, userStr);
        if (result > 0)
        {
