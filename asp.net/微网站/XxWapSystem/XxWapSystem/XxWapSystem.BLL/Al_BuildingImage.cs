...
{
    /// <summary>
    /// 业务逻辑类Al_BuildingImage 的摘要说明。
    /// </summary>
    public class Al_BuildingImage
    {
        private static readonly XxWapSystem.DAL.Al_BuildingImage dal = new XxWapSystem.DAL.Al_BuildingImage();
