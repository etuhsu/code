...
{
    /// <summary>
    /// 业务逻辑类Al_BuildingFeatures 的摘要说明。
    /// </summary>
    public class Al_BuildingFeatures
    {
        private static readonly XxWapSystem.DAL.Al_BuildingFeatures dal = new XxWapSystem.DAL.Al_BuildingFeatures();
